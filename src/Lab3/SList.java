...
public class SList {
	...
	/**
	 * nth() returns the item at the specified position. If position < 1 or position
	 * > this.length(), null is returned. Otherwise, the item at position "position"
	 * is returned. The list does not change.
	 * 
	...
	/**
	 * testAfterInsertFront() tests toString(), isEmpty(), length(), insertFront(),
	 * and insertEnd() after insertFront(). Prints summary information of the tests
	...
	/**
	 * testAfterInsertEnd() tests toString(), isEmpty(), length(), insertFront(),
	 * and insertEnd() after insertEnd(). Prints summary information of the tests
	 * and halts the program if errors are detected.
	 **/
	 ...
	 * basic operations and halts with an error (and a stack trace) if any of the
	 * tests fail.
	 **/
